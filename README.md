...
Les groupes compositionnels sont fermés avec une part résiduelle explicite puis transformés en ILR avant d'entrer au modèle. Aucune sélection de variables : tout entre, et le GP à portée isotrope atténue de lui-même ce qui ne porte pas de signal (une portée par variable — ARD — a été testée : elle optimise la vraisemblance, pas la prédiction, et surcharge hors échantillon; rejetée). R² multivarié hors échantillon (50% ×15) : 0,44, contre 0,38 pour la régression ridge qu'il remplace.
