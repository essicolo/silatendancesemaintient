...
const CROSSTABS = [
  ...
  { source: "Léger 2026-09-21 (Rapport intentions de vote - 21 septembre 2026.pdf, p.7)",
    PQ: [29, 21, 32, 32], CAQ: [20, 13, 11, 30], LIB: [23, 26, 25, 21], PCQ: [17, 18, 21, 13], QS: [10, 21, 11, 3] },
];
